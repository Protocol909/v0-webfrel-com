    ...
    <section className="py-24 bg-black relative" id="process">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center border border-white/20 py-1 px-4 rounded-full text-xs font-medium text-white/80 backdrop-blur-sm mb-4">
            How We Work
          </div>
          <h2 className="text-3xl md:text-5xl font-bold tracking-tighter text-white mb-4">Our Process</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            A streamlined approach to delivering exceptional results.
          </p>
        </div>

        <ul className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-12 lg:grid-rows-3 xl:max-h-[34rem] xl:grid-rows-2">
          <GridItem
    ...
    <li className={cn("min-h-[14rem] list-none", area)}>
      <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-white/10 p-2 md:rounded-[1.5rem] md:p-3">
        <GlowingEffect
          ...
          variant="white"
        />
        <div className="relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl border-[0.75px] border-white/10 bg-black p-6 shadow-sm dark:shadow-[0px_0px_27px_0px_rgba(45,45,45,0.3)] md:p-6">
