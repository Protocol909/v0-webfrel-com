...
export interface TimeLine_01Props {
  ...
  hideHeader?: boolean // Added hideHeader prop
}
...
export default function TimeLine_01({
  ...
  entries = [],
  useTextEffect = false,
  hideHeader = false, // Added hideHeader prop
}: TimeLine_01Props) {
        ...
        {!hideHeader && (
          <div className="mx-auto max-w-3xl text-center mb-10 sm:mb-12 md:mb-16">
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-4 sm:mb-6">
              <span className="text-xs sm:text-sm text-gray-400">Our Work</span>
            </div>
            {useTextEffect ? (
              <ScrollTextEffect
                preset="blur"
            ...
            <p className="mb-6 text-sm sm:text-base text-gray-400 md:text-lg max-w-2xl mx-auto">{description}</p>
          </div>
        )}
        ...
        <div className="mx-auto mt-8 sm:mt-12 md:mt-16 lg:mt-24 max-w-3xl relative" ref={timelineRef}>
          ...
          >
            <motion.div
              ...
              className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-b from-white via-white/80 to-white/40 rounded-full"
            />
          </div>
                  ...
                  <div className="hidden md:flex top-8 h-min w-48 lg:w-64 shrink-0 items-center gap-4 sticky">
                    <div className="flex items-center gap-3">
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-gray-400">{entry.subtitle}</span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <p
                          className={
                            ...
                            (isActive ? "text-gray-400 line-clamp-none" : "text-gray-500 line-clamp-2")
                          }
                        >
                          {entry.description}
                        </p>
