...
import { AnimatePresence, motion, type TargetAndTransition, type Variants, useInView } from "framer-motion"
...
export function TextEffect({
  ...
  const shouldAnimate = scrollTriggered ? isInView : trigger
...
export function ScrollTextEffect({
  ...
  preset = "blur",
  delay = 0,
}: Omit<TextEffectProps, "trigger" | "scrollTriggered">) {
  const ref = useRef(null)
  const isInView = useInView(ref, {
    once: false,
    amount: 0.5,
